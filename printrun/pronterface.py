...
class PronterWindow(MainWindow, pronsole.pronsole):
    ...
    def about(self, event):
        ...
        for window in self.GetChildren():
            if isinstance(window, about.AboutDialog):
                # Raise() does not work with AboutBox,
                # therefore we will just reopen it.
    ...
    def add_cmdline_arguments(self, parser):
        ...
        parser.add_argument('-a', '--autoconnect', help = _("automatically try to connect to printer on startup"),
                                                            action = "store_true")

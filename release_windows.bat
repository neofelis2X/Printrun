...
pyi-makespec -F --name "Plater" --add-data "images/*;images"  --add-data "assets/icons/pronterface/*.png;assets/icons/pronterface" --add-data "./assets/icons/*.ico;." -w -i "./assets/icons/g-plater.ico" plater.py

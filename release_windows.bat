...
pyi-makespec -F --name "Pronterface" --add-data "images/*;images" --add-data "assets/icons/pronterface/*.png;assets/icons/pronterface" --add-data "assets/toolbar/*.svg;assets/toolbar" --add-data "assets/icons/*.ico;." -w -i "./assets/icons/pronterface.ico" pronterface.py
...
pyi-makespec -F --name "Plater" --add-data "images/*;images"  --add-data "assets/icons/pronterface/*.png;assets/icons/pronterface" --add-data "./assets/icons/*.ico;." -w -i "./assets/icons/g_plater.ico" plater.py
